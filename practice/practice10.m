...
% use of files example_meshgrid.m, charge1.m, charge2.m

% radius of one type of particles should be bigger than of the second type
...
idx3=(R<d); % grids inside the radious
V3max = K*q3 / d;

%% sum (contribution of both chrages) and find max value 
V=V1+V2+V3; % contribution of both chrages !!!!
